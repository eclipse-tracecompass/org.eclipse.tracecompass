...
public class Activator extends AbstractUIPlugin {
    ...
    /** The plugin ID */
    public static final String PLUGIN_ID = "org.eclipse.tracecompass.analysis.callstack.ui"; //$NON-NLS-1$
    ...
    public static Activator getDefault() {
        ...
        if (activator == null) {
            throw new IllegalArgumentException("This method should not be called when Activator is null"); //$NON-NLS-1$
        }
        return activator;
    }
